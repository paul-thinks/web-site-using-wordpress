<!-- wp:group {"style":{"spacing":{"blockGap":"5px","padding":{"bottom":"50px"}}}} -->
...
<p class="has-text-align-center animated animated-fadeInUp has-primary-color has-text-color" style="letter-spacing:4px"><?php echo esc_html__( 'Section Sub Title Here', 'gutenify-photography' ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="has-text-align-center animated animated-fadeInUp"><?php echo esc_html__( 'Section Title Here', 'gutenify-photography' ); ?></h2>
<!-- /wp:heading -->
